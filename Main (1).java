...
public class Main
{
	public static void main(String[] args) {
		...
		if(reader.nextInt() == 1) //(reader.nextInt takes a NUMBER from the reader, not true or false)
		    turn = true; //only happens if the IF STATEMENT IS TRUE & player goes first
		else
		    turn = false;
		    
		//game stops when we get to 0 sticks
		//so the game must continue to run as long as the number of sticks is > 10
